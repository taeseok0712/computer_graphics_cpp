...
void moverandom() {
	random_device rd;
	default_random_engine dre(rd());
	uniform_real_distribution<>uid(0.00, 0.07);
	float a1 = uid(dre);
	float b1 = uid(dre);
	random_xmove = a1;
	random_ymove = b1;
...
void initbuffer() {
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(RecData), &RecData, GL_STREAM_DRAW);
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
...
void timer(int value) {
	...
	for (int i = 0; i < size2; i++) {
		...
		temp2.data[0] += temp2.vectorx * temp2.xmove;
		temp2.data[6] += temp2.vectorx * temp2.xmove;
		temp2.data[12] += temp2.vectorx * temp2.xmove;
	...
	if (check) {
		for (int i = 0; i < sizet; i++) {
			...
			if (temp.data[0] >= 1.0 || temp.data[6] >= 1.0 || temp.data[12] >= 1.0) {
			...
			else if ((temp.data[0] >= -0.5 && temp.data[0] <= 0.5) || (temp.data[6] >= -0.5 && temp.data[6] <= 0.5) || (temp.data[12] >= -0.5 && temp.data[12] <= 0.5)) {
				if (temp.rotate % 4 == 1) {
					if ((temp.data[1]<=-0.5&&temp.data[13]<=-0.5) && temp.data[7]>=-0.5) {
						rotatetri(&temp);
						temp.vectory = -1.0;
					}
					else if ((temp.data[1] <= 0.5 && temp.data[13] <= 0.5) && temp.data[7] >= 0.5) {
						rotatetri(&temp);
						temp.vectory = 1.0;
					}
				}
				else if (temp.rotate % 4 == 2) {
					if ((temp.data[1] <= -0.5 && temp.data[7] <= -0.5) && temp.data[13] >= -0.5) {
						rotatetri(&temp);
						temp.vectory = -1.0;
					}
					else if ((temp.data[7] >= 0.5 && temp.data[13] >= 0.5) && temp.data[1] <= 0.5) {
						rotatetri(&temp);
						temp.vectory = 1.0;
					}
				}
				else if (temp.rotate % 4 == 3) {
					if ((temp.data[1] >= -0.5 && temp.data[13] >= -0.5) && temp.data[7] <= -0.5) {
						rotatetri(&temp);
						temp.vectory = -1.0;
					}
				...
				else if (temp.rotate % 4 == 0) {
					if ((temp.data[7] <= -0.5 && temp.data[13] <= -0.5) && temp.data[1] >= -0.5) {
						rotatetri(&temp);
						temp.vectory = -1.0;
					}
					else if ((temp.data[1] >= 0.5 && temp.data[7] >= 0.5) && temp.data[13] <= 0.5) {
						rotatetri(&temp);
						temp.vectory = 1.0;
					}
				}
			...
			if ((temp.data[1] >= -0.5 && temp.data[1] <= 0.5) || (temp.data[7] >= -0.5 && temp.data[7] <= 0.5) || (temp.data[13] >= -0.5 && temp.data[13] <= 0.5)) {
				if (temp.rotate % 4 == 1) {
					if ((temp.data[0] <= -0.5 && temp.data[6] <= -0.5) && temp.data[12] >= -0.5) {
						rotatetri(&temp);
						temp.vectorx = -1.0;
					}
					else if ((temp.data[6] >= 0.5 && temp.data[12] >= 0.5) && temp.data[0] <= 0.5) {
						rotatetri(&temp);
						temp.vectorx = 1.0;
					}
				}
				else if (temp.rotate % 4 == 2) {
					if ((temp.data[0] >= -0.5 && temp.data[12] >= -0.5) && temp.data[6] <= -0.5) {
						rotatetri(&temp);
						temp.vectorx = -1.0;
					}
					else if ((temp.data[0] >= 0.5 && temp.data[12] >= 0.5) && temp.data[6] <= 0.5) {
						rotatetri(&temp);
						temp.vectorx = 1.0;
					}
				}
				else if (temp.rotate % 4 == 3) {
					if ((temp.data[6] <= -0.5 && temp.data[12] <= -0.5) && temp.data[0] >= -0.5) {
						rotatetri(&temp);
						temp.vectorx = -1.0;
					}
					else if ((temp.data[0] >= 0.5 && temp.data[6] >= 0.5) && temp.data[12] <= 0.5) {
						rotatetri(&temp);
						temp.vectorx = 1.0;
					}
				}
